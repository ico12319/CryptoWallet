...
func CraftActionWithTokenCommand(actionCommand string, assetId string, amount float64, cacher *priceCache.PriceCache, updater apiCaller.PriceFetcher) (userBuySellCommands.UserActionWithToken, error) {
